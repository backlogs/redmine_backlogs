...
#and use 1.2.3 as we do not specify the version in our Gemfile to ease up user installation
cat <<__END > ${PATH_TO_REDMINE}/Gemfile.rb_testenv
#this file is autogenerated by redmine_install.sh. It is only used for feature tests.
group :test do
